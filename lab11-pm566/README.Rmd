...
date range: from "2020-01-21" to "2021-11-11"
range of cases: from 1 to 4993930   
range of deaths: from 0 to 73132
```{r}
# format the date
...
The case case fatality rate increased in New York and decreased in other states. It may due to large amount of cases but limited medical resources in New York. 
